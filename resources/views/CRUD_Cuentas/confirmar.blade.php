    ...
    <div class="row">
		...
		@endswitch
			<div class="panel-body">
				  <span class="label label-default" style="float: right">{{ Carbon\Carbon::parse($cuenta->created_at)->format('d-m-Y  h:i:s A') }}</span>
			...
			<div class="panel-footer">
				<div class="row">
					...
					<div class="col-lg-6 col-md-6  col-sm-6 col-xs-6">
						<a href="{{url('/estado/'.$cuenta->id)}}" class="btn btn-default btn-lg btn-block"  role="button"><span class="glyphicon glyphicon-check"></span>  Confirmar</a>
					</div>	
				</div>  
			</div>     
		</div>
